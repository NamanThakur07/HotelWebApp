...
export const LOGIN_URL = `http://localhost:2001/staff/login`
export const VERIFY_URL = `http://localhost:2001/staff/verifyOtp`
export const RESEND_URL = `http://localhost:2001/staff/resendOtp`
